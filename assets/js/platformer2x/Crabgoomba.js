...
export class Crabgoomba extends Character {
    ...
    update() {
        ...
        //Random Event 2: Time Stop All crabgoombas
        if (GameControl.randomEventId === 2 && GameControl.randomEventState === 1) {
            this.speed = 0;
            if (this.name === "CrabgoombaSpecial") {
                GameControl.endRandomEvent();
            };
        };

        //Random Event 3: Kill a Random crabgoomba
        //Whichever Crabgoomba recieves this message first will die, then end the event so the other Goombas don't die
        ...
        switch(GameEnv.difficulty) {
         ...
         //Chance for crabgoomba to turn Gold
        ...
        //Immunize crabggoomba & Texture It
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "player") {
            // Collision: Top of crabgoomba with Bottom of Player
        ...
        if (this.collisionData.touchPoints.other.id === "crabgoomba") {
